...
public class Question2 extends javax.swing.JFrame {
    ...
    int score=0;
    public Question2(int questionsAnswered, int score) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("  Identify the return type of a method that does not return any value.");
    ...
    private void btnCheckAnswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckAnswerActionPerformed
        ...
        else
        {
            ...
            {
                blAnswerStatus.setText("Incorrect--Answer is void");
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        else
        {
            ...
            new Question3(questionsAnswered, score).setVisible(true);
            this.dispose();
        }
