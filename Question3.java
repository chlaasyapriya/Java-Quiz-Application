...
public class Question3 extends javax.swing.JFrame {
    ...
    int score=0;
    public Question3(int questionsAnswered, int score) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Output of Math.floor(3.6)");
    ...
    private void btnCheckAnswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckAnswerActionPerformed
        ...
        else
        {
            ...
            {
                blAnswerStatus.setText("Incorrect--Answer is 3.0");
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        else
        {
            ...
            new Question4(questionsAnswered, score).setVisible(true);
            this.dispose();
        }
